...
import { getPlans, getProgramList } from "@/lib/catalog";
...
export default async function PricingPage() {
  ...
  ] = await Promise.all([getPlans(), getProgramList()]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="flex flex-wrap gap-2 mb-4">
              <CatalogSourceHint label="Pricing plans" source={plansSource} />
              <CatalogSourceHint label="Pricing programs" source={programsSource} />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {plans && plans.length > 0 ? (
            ...
            <p className="text-text-muted">
              Plans are currently unavailable. Please try again later.
            </p>
          )}
        </div>
      </section>
